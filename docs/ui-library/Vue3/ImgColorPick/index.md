<script setup>
import { ref } from 'vue'
import ImgColorPick from './ImgColorPick.vue'
...
## 示例
<div class="img-color-pick-demo">
  <button class="pick-button" @click="showPick = true">点击取色</button>
  <div class="color-box" :style="{ backgroundColor: curColor }"></div>
  <ImgColorPick v-if="showPick" :img-url="imgUrl" @select="handleColorSelect" @close="handleClose" hide-on-click-modal />
</div>

```vue
<script setup>
import { ref } from 'vue'
import ImgColorPick from '...'
const showPick = ref(false)
const curColor = ref('')
const imgUrl = 'https://img2.baidu.com/it/u=3849054932,2988350768&fm=253&app=120&size=w931&n=0&f=JPEG&fmt=auto?sec=1680022800&t=77f347d9193d5608690cb9de8101471d'
